...
// requiring helpers
const octalToDecimal = require("../helpers/octalToDecimal");

let octalToDecimalCmd = vscode.commands.registerCommand(
  "number-converter.convertOctalToDecimal",
  function () {
    ...
    try {
      const answer = octalToDecimal(number);
      editor.edit((edit) => {
...
module.exports = octalToDecimalCmd;
