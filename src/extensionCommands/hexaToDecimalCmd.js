...
// requiring helpers
const hexaToDecimal = require("../helpers/hexaToDecimal");

let hexaToDecimalCmd = vscode.commands.registerCommand(
  "number-converter.convertHexaToDecimal",
  function () {
    ...
    try {
      const answer = hexaToDecimal(number);
      editor.edit((edit) => {
...
module.exports = hexaToDecimalCmd;
